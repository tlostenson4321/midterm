...
angular.module('beerApp')
	.factory('beerFactory', function(){
		...
		var fourNoses = new Brewery('4 Noses brewing Comapny', 'Broomfield', '8855 W 116th Cir. #4', 'http://4nosesbrewing.com', ['Barrel Aged Beers', 'Fresh Flavors'], [blonde, ipa, porter, paleAle])
		...
		var wonderland = new Brewery('Wonderland Brewing Company', 'Broomfield', '5450 W 120th Ave.', 'http://wonderlandbrewing.com', ['"Care, Creativity and Time"', 'beer as therapy'], [blonde, ipa, saison, fruit, porter, amber, stout, paleAle])
